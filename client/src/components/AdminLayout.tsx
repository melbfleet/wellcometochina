...
import {
  LayoutDashboard, MapPin, Compass, Map, Route as RouteIcon, Tag, Mail, LogOut, Menu, X, ChevronRight, Images, Info, Home, ContactRound,
} from "lucide-react";
...
const NAV_ITEMS = [
  ...
  { label: "Contact Information", path: "/admin/contact-information", icon: ContactRound },
